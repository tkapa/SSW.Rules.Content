...
::: bad  
![Figure: Bad example - SQL RS does not work in Chrome by default](report-display-bad_1727405132320.jpg)  
:::
...
::: good  
![Figure: Good example - SQL RS fixed to correctly display in Chrome](report-display-good_1727405132321.jpg)
:::
